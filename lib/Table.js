...
var _lodash3 = require('lodash.conforms');
...
var Table = exports.Table = (_temp2 = _class = function (_React$Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      data: _this.props.data.map(function (d) {
        return _extends({}, d, { _table_id: _shortid2.default.generate() });
      }),
      ...
      _this.setState({
        data: [].concat(_this.props.data, [item]).map(function (d) {
          return _extends({}, d, {
            _table_id: _shortid2.default.generate()
          });
        })
      });
      ...
      var orderedRows = (0, _lodash2.default)(data, iteratees, orders);
      var filteredRows = orderedRows.filter((0, _lodash4.default)(filterPredicate));
  ...
  Table.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      _TableContext.TableProvider,
      { value: props },
      component ? _react2.default.createElement(component, props) : render ? render(props) : typeof children === 'function' ? children(props) : !(_react2.default.Children.count(children) === 0) ? _react2.default.Children.only(children) : null
    );
  };
...
Table.propTypes = process.env.NODE_ENV !== "production" ? {
  columns: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    accessor: _propTypes2.default.string
  })),
  data: _propTypes2.default.array,
  currentPage: _propTypes2.default.number,
  pageSize: _propTypes2.default.number,
  pageSizeOptions: _propTypes2.default.arrayOf(_propTypes2.default.number),
  sorting: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    id: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
    asc: _propTypes2.default.bool
  })),
  filtering: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    id: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
    value: _propTypes2.default.any
  })),
  selecting: _propTypes2.default.arrayOf(_propTypes2.default.string)
} : {};