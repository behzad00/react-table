...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactNfTable"] = factory(require("prop-types"), require("react"));
	else
		root["ReactNfTable"] = factory(root["PropTypes"], root["React"]);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(5), __webpack_require__(4)(module)))
...
var lodash_orderby = __webpack_require__(8);
var lodash_orderby_default = /*#__PURE__*/__webpack_require__.n(lodash_orderby);

// EXTERNAL MODULE: ./node_modules/lodash.conforms/index.js
var lodash_conforms = __webpack_require__(7);
var lodash_conforms_default = /*#__PURE__*/__webpack_require__.n(lodash_conforms);

// CONCATENATED MODULE: ./src/TableContext.js


var TableContext_React$createContext = external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createContext(),
    TableContext_TableProvider = TableContext_React$createContext.Provider,
    TableContext_TableConsumer = TableContext_React$createContext.Consumer;
...
var Table_Table = (Table_temp2 = Table_class = function (_React$Component) {
  ...
  function Table() {
    ...
    return _ret = (_temp = (_this = Table_possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      columns: _this.props.columns,
      data: _this.props.data.map(function (d) {
        return Table_extends({}, d, { _table_id: shortid_default.a.generate() });
      }),
      ...
      return _this.setState(function (state) {
        ...
        return {
          ...
          }) : [], [Boolean(sortedColumn) ? Table_extends({}, sortedColumn, { asc: !sortedColumn.asc }) : { id: columnAccessor, asc: true }])
        };
      });
      ...
      _this.setState(function (state) {
        ...
        return {
          filtering: [].concat(filtering.filter(function (_ref4) {
            var id = _ref4.id;
            return id !== columnAccessor;
          }), [filteredColumn ? Table_extends({}, filteredColumn, { value: value }) : { id: columnAccessor, value: value }])
        };
      });
      ...
      _this.setState({
        data: [].concat(_this.props.data, [item]).map(function (d) {
          return Table_extends({}, d, {
            _table_id: shortid_default.a.generate()
          });
        })
      });
      ...
      _this.setState(function (state) {
        return {
          data: state.data.map(function (d) {
            return d._table_id === rowKey ? Table_extends({}, updatedItem, {
              _table_id: shortid_default.a.generate()
            }) : d;
          })
        };
        ...
        return {
          data: _this.state.data.map(function (d) {
            if (d._table_id === rowKey) {
              ...
              return Table_extends({}, d, (_extends2 = {
                _table_id: shortid_default.a.generate()
      ...
      var orderedRows = lodash_orderby_default()(data, iteratees, orders);
      var filteredRows = orderedRows.filter(lodash_conforms_default()(filterPredicate));
      ...
      return Table_extends({}, _this.state, _this.getComputedProps(), _this.getActions());
  ...
  Table.prototype.render = function render() {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
      TableContext_TableProvider,
      { value: props },
      component ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(component, props) : render ? render(props) : typeof children === 'function' ? children(props) : !(external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Children.count(children) === 0) ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Children.only(children) : null
    );
  };

  return Table;
}(external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Component), Table_class.propTypes = {
  columns: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.shape({
    accessor: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string
  })),
  data: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.array,
  currentPage: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number,
  pageSize: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number,
  pageSizeOptions: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number),
  sorting: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.shape({
    id: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number]),
    asc: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.bool
  })),
  filtering: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.shape({
    id: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number]),
    value: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.any
  })),
  selecting: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string)
}, Table_class.defaultProps = {
  columns: [],
  data: [],
  currentPage: 1,
  pageSize: 8,
...
// CONCATENATED MODULE: ./src/TableHeaderRow.js
var TableHeaderRow_extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

var TableHeaderRow_class, TableHeaderRow_temp;

function TableHeaderRow_classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function TableHeaderRow_possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function TableHeaderRow_inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }





var TableHeaderRow_TableHeaderRow = (TableHeaderRow_temp = TableHeaderRow_class = function (_React$Component) {
  TableHeaderRow_inherits(TableHeaderRow, _React$Component);

  function TableHeaderRow() {
    TableHeaderRow_classCallCheck(this, TableHeaderRow);

    return TableHeaderRow_possibleConstructorReturn(this, _React$Component.apply(this, arguments));
  }
  ...
  TableHeaderRow.prototype.render = function render() {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
      TableContext_TableConsumer,
      null,
      function (tableProps) {
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
          external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Fragment,
          null,
          external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(TableHeaderRow_HeaderData, TableHeaderRow_extends({}, _this2.props, {
            setHeaderData: tableProps ? tableProps.setHeaderData : null
          })),
          component ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(component, _this2.props) : children
        );
      }
    );
  };
...
}(external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Component), TableHeaderRow_class.propTypes = {
  children: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.arrayOf(external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.element, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.func])), external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.element]),
  component: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.element, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.func, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string])
}, TableHeaderRow_temp);

var TableHeaderRow_HeaderData = function (_React$Component2) {
  TableHeaderRow_inherits(HeaderData, _React$Component2);

  function HeaderData() {
    var _temp2, _this3, _ret;

    TableHeaderRow_classCallCheck(this, HeaderData);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp2 = (_this3 = TableHeaderRow_possibleConstructorReturn(this, _React$Component2.call.apply(_React$Component2, [this].concat(args))), _this3), _this3.state = {
      columns: external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Children.map(_this3.props.children, function (_ref) {
        var props = _ref.props;
        return TableHeaderRow_extends({}, props, {
    ...
    }, _temp2), TableHeaderRow_possibleConstructorReturn(_this3, _ret);
  }
...
// CONCATENATED MODULE: ./src/TableHeader.js
...
var TableHeader_class, TableHeader_temp;
...
var TableHeader_TableHeader = (TableHeader_temp = TableHeader_class = function (_React$Component) {
  TableHeader_inherits(TableHeader, _React$Component);

  function TableHeader() {
    TableHeader_classCallCheck(this, TableHeader);

    return TableHeader_possibleConstructorReturn(this, _React$Component.apply(this, arguments));
  }
  ...
  TableHeader.prototype.render = function render() {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(
      ...
      function () {
        ...
        var returnProps = TableHeader_extends(TableHeader_extends({}, _this2.props, { sortable: null, filterable: null }), sortable && typeof component !== 'string' ? {
          isSorting: isSorting,
          sortable: sortable,
        ...
        return component ? external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.createElement(component, returnProps, children) : render ? render(returnProps) : typeof children === 'function' ? children(returnProps) : children;
      }
    );
  };

  return TableHeader;
}(external_root_React_commonjs2_react_commonjs_react_amd_react_default.a.Component), TableHeader_class.propTypes = {
  render: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.func,
  component: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.element, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.func, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string]),
  children: external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.oneOfType([external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.element, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.func, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.string, external_root_PropTypes_commonjs2_prop_types_commonjs_prop_types_amd_prop_types_default.a.number])
}, TableHeader_temp);
// CONCATENATED MODULE: ./src/index.js
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "Table", function() { return Table_Table; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TableHeaderRow", function() { return TableHeaderRow_TableHeaderRow; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "HeaderData", function() { return TableHeaderRow_HeaderData; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TableHeader", function() { return TableHeader_TableHeader; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TableProvider", function() { return TableContext_TableProvider; });
/* concated harmony reexport */__webpack_require__.d(__webpack_exports__, "TableConsumer", function() { return TableContext_TableConsumer; });
